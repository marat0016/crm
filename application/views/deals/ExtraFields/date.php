<div class="newInputClass" data-type="6" data-new="true">
    ...
    <input name="extra_fields[]" class="datepicker-input form-control" size="16" type="text" value="12-02-2013" data-date-format="dd-mm-yyyy" >
</div>