<div class="newInputClass" data-type="2" data-new="true">
    ...
    <input name="extra_fields[]" type="text" data-trigger="change" data-required="true" class="form-control" data-type="number">
</div>