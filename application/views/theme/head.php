            ...
            <form class="navbar-form navbar-left input-s-lg m-t m-l-n-xs hidden-xs" role="search">
                <div class="form-group">
                    <div class="input-group"> <span class="input-group-btn">
                      ...
                      <input type="text" class="form-control input-sm no-border" placeholder="<?=lang("search_text");?>">
                    </div>
                </div>
            </form>
            <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
                <li class="hidden-xs"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-comment"></i> <span class="badge badge-sm up bg-danger count">2</span> </a>
                ...
                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="<?=get_photo($this->account->getInfo()->photo);?>"> </span> <?=$this->account->getInfo()->name;?> <b class="caret"></b> </a>
